...
<div class="container">
    <div class="profile-header">
        <div class="profile-avatar" style="background:#e3f2fd;color:#1976d2;">
            👤
        </div>
        <h1>Profile: <?php echo htmlspecialchars($user_username); ?></h1>
    ...
    <div class="btn-group">
        ...
        <a href="../seller/dashboard.php" class="btn">Dashboard</a>
        <?php endif; ?>
        <form action="../logout.php" method="POST" style="display:inline-block">
            <button class="btn btn-danger" style="border:none;cursor:pointer">Logout</button>
        </form>
    </div>
</div>
